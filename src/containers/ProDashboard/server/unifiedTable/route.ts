...
import { fetchProtocolsTable, type ChainMetrics } from './protocols'
...
export default withApiRouteTelemetry('/api/public/pro-dashboard/unified-table/[strategy]', handler)
